 ...
 * Theme Names
 */
export const themeNames = ['default', 'ocean', 'forest', 'Thailand Night'] as const
...
export interface ColorPalette {
  light: {
    background: { normal: string; active: string }
    border: { normal: string; active: string }
    primary: { normal: string; active: string }
    danger: { normal: string; active: string }
    info: { normal: string; active: string }
    success: { normal: string; active: string }
    warning: { normal: string; active: string }
  }
  dark: {
    background: { normal: string; active: string }
    border: { normal: string; active: string }
 ...
 */
export const preinstalledIcons = [
  'mdi',
  'logos',
  'heroicons',
  'lucide',
...
export type PreinstalledIcon = typeof preinstalledIcons[number]
